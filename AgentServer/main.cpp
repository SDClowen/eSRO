...
#define DAEMON "agentd"
#define PID_FILE "/var/run/agentd.pid"
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        {
            std::cerr << srv.GetLastError() << std::endl;
            return 1;
        }
    ...
    {
        syslog(LOG_WARNING,"Server Exception: %s",e.what());
        return 1;
    }
    catch(...)
    {
        syslog(LOG_WARNING,"Server Unhandled error.");
        return 1;
    }
