...
#define DAEMON "masterd"
#define PID_FILE "/var/run/masterd.pid"
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        if (!srv.Initialize(config_entries) || !srv.Execute())
        {
            syslog(LOG_INFO,"Server Error: %s",srv.GetLastError().c_str());
            return 1;
        }
    }
